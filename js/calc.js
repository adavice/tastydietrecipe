(() => {
    ...
    n.r = e => {
        ...
        (() => {
            ...
            function r(e) {
                e.style.backgroundColor = "#ba0017",
                    e.style.color = "white",
                    e.scrollIntoView()
            }
            function o(e, t) {
            ...
            function i(e) {
                ...
                o(u, "maxLiftResultElem"),
                    ...
                    u.resultElem.style.color = "#ba0017",
                    u.resultValue = m,
                    c(m, i),
                    e.preventDefault()
            }
            ...
            function h(e) {
                ...
                v.resultElem.textContent = "Konsumera ".concat(I, " per dag för att uppnå ditt viktmål"),
                    ...
                    p(B),
                    e.preventDefault();
                document.getElementById('recipes_link').href = '/?cal=' + I;
            }
            function p(e) {
...
function show() {
    setTimeout(() => {
        ...
        document.getElementById("recepts_for_calc").style.display = "block";
...
function hide() {
    //document.getElementById("recipes_link").style.display = "block";
    document.getElementById("recepts_for_calc").style.display = "none";
}
